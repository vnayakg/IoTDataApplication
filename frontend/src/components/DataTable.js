...
export default function EnhancedTable({currData}) {
  const [order, setOrder] = React.useState('asc');
  const [orderBy, setOrderBy] = React.useState('value1');
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - currData.length) : 0;
        ...
        <TableContainer>
          ...
          >
            ...
            <TableBody>
              ...
              {stableSort(currData, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.sensor.sensorType}</TableCell>
                      <TableCell align="right">{row.sensor.sensorID}</TableCell>
                      {
                          row.values.map(v =>
